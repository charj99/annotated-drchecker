...
#define V4L2_IOCTL_FUNC "V4IOCTL"
    ...
    public:
        ...
        bool runOnModule(Module &m) override {
            ...
            // 设置 function checker 为 kernel function checker
        ...
        // XJJ: 函数调用点 addAllVisitorAnalysis(currState, &currFunction, &callSites, &allCallBacks);
