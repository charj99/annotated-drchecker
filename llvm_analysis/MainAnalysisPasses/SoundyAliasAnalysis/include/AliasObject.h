...
//#define DEBUG_FETCH_POINTS_TO_OBJECTS
    ...
    public:
         ...
         */
        /*
            taintedFields 列表中存储各个域的污点信息，元素类型为 FieldTaint
            每个 FieldTaint 中又以列表的形式存储各个污点标记 TaintFlag
        */
        ...
        bool taintAllFields(TaintFlag *targetTaintFlag) {
            ...
            if(!this->all_contents_tainted) {
                ...
                // 如果当前对象是指向结构体类型的指针，把该结构体的各个域都标记为污点
